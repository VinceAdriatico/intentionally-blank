                    ...
                    <div class="top-bar-content">
                        ...
                        <?php
                                ...
                                foreach ($utilItems as $item) {
                                    ...
                                    ?>
                                    <a href='<?= $link; ?>' title='<?= $title; ?>' class='top-link w-inline-block <?= $class; ?>'>
                                        <div><?= $title; ?></div>
                                    </a>
                                <?php } ?>
                        </div>
                        ...
                        <nav role="navigation" class="nav-menu w-nav-menu">
                            ...
                            <?php
                                ...
                                foreach ($menuItems as $item) {
                                    ...
                                    $class = $item->classes[0];
                                    ?>
                                    <a href='<?= $link; ?>' title='<?= $title; ?>' class='nav-link w-inline-block <?= $class; ?>'>
                    ...
                    <div class="mega-menu">
                        <div class="large-menu-wrapper">
                            ...
                            <div id="w-node-daa62615-7085-cf47-4f2b-bf94f57b1af2-f57b1a9e"
                                ...
                                <div class="navigation-links">
                                    <a href="#" class="nav-link btn w-inline-block">
